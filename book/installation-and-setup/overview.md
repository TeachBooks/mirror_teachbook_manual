...
| Type 4 | Understanding Git & GitLab<br>Local Git with VS Code / GitHub Desktop<br>Edit using VS Code<br>Anaconda<br>Using Anaconda in terminal<br>Working with directories<br>Python Environments<br>Python package: Jupyter book | [Git & GitLab](git-setup.md)<br>[How do I use git locally?](git-setup_local.md)[VS Code](vscode-setup.md)<br>[Anaconda](anaconda.md)<br>[Anaconda in terminal](add_conda_to_path.md)<br>[Working directories](working-directory.md)<br>[Environments](environments.md)<br>[Jupyter Book](jupyter-book-setup)         |
